...
# =========================================================
    ...
    with col2:
        ...
        academic_performance = st.selectbox(
            ...
            input_options["Academic_Performance"]
        )
    ...
    with col3:
        ...
        leadership = st.selectbox(
            ...
            input_options["Leadership_Experience"]
        )

        linkedin = st.selectbox(
            "LinkedIn Profile",
            input_options["LinkedIn_Profile"]
        )
        ...
        english = st.selectbox(
            "English Proficiency",
            input_options["English_Proficiency"]
        )
    ...
    if predict_button:
        ...
        # The saved model is a complete preprocessing + ML pipeline.
        # Pass the raw student profile directly into the model.
